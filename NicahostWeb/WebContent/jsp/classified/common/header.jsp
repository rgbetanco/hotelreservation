...
<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
	<TBODY>
		<tr>
			...
			<a href="/NicahostWeb/clasificados/anuncieseformat.do">Anúnciese</A>  | <A href="/NicahostWeb/clasificados/orderPage.do"><IMG border="0"
		...
		<TR>
			...
			<TABLE bgcolor="#4c94ba" width="100%">
				<TBODY>
	    		<tr>
					<TD valign="middle" style="color: white; font-weight: bold; font-size: x-small; ">
					
					<html:form action="browse.do">
					&nbsp;BUSCAR:&nbsp; 
	    				<!--input type="text" name="criteria" size="35" value='<c:out value="${param.criteria}" />' /-->
	    				<html:text property="criteria" size="35"></html:text>
