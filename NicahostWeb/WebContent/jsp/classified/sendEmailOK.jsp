	  ...
	  <tr>	  
	    <td colspan="4" align="center"> 
	    	<table border="0" width="550" cellpadding="3" cellspacing="1" id="sessionTable">
	        	...
	        	<tr>
	        		<td colspan="4">
	        			Su mensaje ha sido enviado al vendedor de este producto.  Confirme ese mensaje para activar su cuenta de vendedor o bien 
	        			active su cuenta de vendedor <u>aqui</u>.
