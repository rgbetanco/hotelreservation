	...
	<TBODY>
		<TR>
			<TD><SPAN class="checkoutTitle">orden de compra</SPAN> <SPAN
				class="checkoutSubTitle">| información sobre el pago</SPAN></TD>
		</TR>
		<TR>
			<TD>Casí terminamos! Solamente digite la información correspondiente a su tarjeta de crédito en este formulario. (Esto es completamente seguro - he aquí el porqué). Si prefiere, llamenos y denos su número de tarjeta, y simplemente sólo ingrese los últimos cincos números de la tarjeta. Luego de haber confirmado su orden, llámenos al (505) 848-4018.</TD>
		</TR>
	</TBODY>
</TABLE>
...
<TABLE border="0">
	<TBODY>
		<TR>
			<TD colspan="2">Tarjeta de crédito</TD></TR>
		<TR>
			<TD align="right">
		...
		<TR>
			<TD align="right"><SPAN class="daterror"> <logic:messagesPresent
					...
					<logic:messagesPresent property="cardYear"><strong><SPAN
							class="daterror">Fecha de expiración:*</SPAN></strong></logic:messagesPresent>
					Fecha de expiración<logic:messagesNotPresent property="cardYear">:</logic:messagesNotPresent>					
