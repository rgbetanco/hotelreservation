		...
		<TR>
			...
			<TABLE border="0">
				<TBODY>
					<TR>
						<TD>
						<B>Para clientes nuevos</B><br>Si quiere vender su producto en línea, necesita registrarse primero. <BR>
						<BR>Regístrese gratis.<BR>
						<FORM action="/NicahostWeb/clasificados/createAccount.do">

							<INPUT type="hidden" name="nextview" value="newselleraccount">							
			...
			<TD width="50%">
				<html:form action="signinselleronline.do" focus="email">
<TABLE border="0">
	<TBODY>
		<TR>
			<TD colspan="2">
			...
			<BR>¿Nuevo vendedor? Asegúrese de:
				<UL>
					<LI><U>Aprenda a vender</U>.</LI> 
					<LI>Conozca sobre <U>cargos por ventas</U>.</LI>
				</UL>
							</TD>
		</TR>
		<TR>
		...
		<TR>		
			<TD></TD>
			<TD>
				<html:hidden property="nextview" value="sell"/>
		...
		<TR>
			...
			<TD>¿Olvidó su contraseña? Pulse <A
								href="/NicahostWeb/clasificados/showforgotpwd.do"><U>aquí</U></A>...<BR>¿Cambió su <U>correo
							electrónico</U>?</TD>
		</TR>
	</TBODY>
</TABLE>
